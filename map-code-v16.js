...
class LiveLocationControl extends mapboxgl.GeolocateControl {
  ...
  onAdd(map) {
      ...
      // Search for the .location-button class starting from the document
      const locationButton = document.querySelector('.location-button');

      // Check if the .location-button element is found
      if (locationButton) {
          console.log('.location-button element is found');
          // Add a click event listener to the .location-button element
