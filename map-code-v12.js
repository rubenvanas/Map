...
class LiveLocationControl extends mapboxgl.GeolocateControl {
  ...
  onAdd(map) {
      ...
      // Add click event listener to elements with the class ".location-button"
      const locationButtons = container.querySelectorAll('.Navigation .location-button');
...
map.addControl(liveLocationControl, 'top-left');
